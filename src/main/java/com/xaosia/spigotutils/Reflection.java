...
public final class Reflection {
	...
	/**
	 * Sets the value of a superclass field of the given class of an object
	 *
	 * @param instance Target object
	 * @param clazz Target class
	 * @param declared Whether the desired field is declared or not
	 ...
	 * @see #getField(Class, boolean, String)
	 */
	public static void setSuperclassValue(Object instance, Class<?> clazz, boolean declared, String fieldName, Object value) throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException, SecurityException {
		getField(clazz.getSuperclass(), declared, fieldName).set(instance, value);
	}
	...
	public enum PackageType {
		...
		WINTER_IS_COMING_PLAYER_CLASS("com.gmail.val59000mc.winteriscoming.classes"),
		HARDCRAFTPVP("com.gmail.val59000mc.hardcraftpvp"),
		HARDCRAFTPVP_GAMESERVER(HARDCRAFTPVP,"gameserver");
